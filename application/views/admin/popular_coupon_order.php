						...
						<div class="card col-md-12">
							...
							<div class="card-block">
								<div class="dt-responsive table-responsive">
                                    ...
                                    <h3>All popular coupons (<?php echo count($coupons_code);?>)</h3>
                                  ...
                                  <?php
                                    ...
                                    ?>
                                    <ul class="list-unstyled page_list" id="popularr">
                                        <?php 
                                      ...
                                      <!--   <li id="<?php echo $coupons["coupons_id"]; ?>">
                                        ...
                                        <!-- <?php echo $coupons['popular_order']; ?> -->
                                        <li id="<?php echo $coupons["coupons_id"]; ?>">
                                    ...
                                    <?php
                                        ...
                                        ?>
                                        <h2 style="font-size: 20px;justify-content: center;display: flex;padding: 35px;background: #8345451c;margin: 27px;">No popular coupons available </h2>
                                       <?php
                                    }
                                    ?>
