<?php 
    $details_brands = $this->db->get_where('categories', array('categories_id'=>$param2))->row_array();
    $details = $this->db->get_where('brands_contents', array('categories_id'=>$param1))->row_array();
	$brand_image_url = $this->db->get_where('system_settings',array('type'=>'category_imgs_url'))->row()->description;
	$slider_image_url = $this->db->get_where('system_settings',array('type'=>'category_slider_imgs_url'))->row()->description;
...
<div class="row">
	<div class="col-md-12">
		<div class="card m-b-30">
			<h4 class="card-header mt-0"><i class="fa fa-pencil"></i>Edit Category content</h4>
			<div class="card-body">
				<form action="<?php echo base_url().strtolower($this->session->userdata('directory')). '/brands_contents/edit'; ?>" method="post"  enctype ='multipart/form-data'>
