...
<div class="card">
	<h4 class="card-header mt-0"><i class="fa fa-plus"></i> Add Brand Content</h4>
	<div class="card-body">
		<form action="<?php echo base_url().strtolower($this->session->userdata('directory')). '/brand_content/add'; ?>" method="post"  enctype ='multipart/form-data'>
