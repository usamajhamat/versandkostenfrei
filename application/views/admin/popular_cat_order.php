						...
						<div class="card col-md-12">
							...
							<div class="card-block">
								<div class="dt-responsive table-responsive"> 
                                    <h3>All popular categories (<?php echo count($all_categories);?>)</h3>
                                  <?php
                                    
                                    if(!empty($all_categories)){
                                    ?>
                                    <ul class="list-unstyled page_list" id="popular_category_sort">
                                        <?php 
                                        ...
                                        <li id="<?php echo $coupons["categories_id"]; ?>">
														...
														<div class="cs-flex cs-flex-mobil cs-outer-coupon coupons_padd" >
															<div class="cs-coupon-box-cell-1  cs-flex cs-flex-mobil coupon_click"  >
																<div class="cs-coupon-logo cs-flex cs-flex-mobil">  
																	 <img style="width: 150px;object-fit: cover;height: 109px;" src="<?php echo base_url();?>uploads/categories/<?php echo $coupons['cat_image'];?>">
																</div>
															</div>
