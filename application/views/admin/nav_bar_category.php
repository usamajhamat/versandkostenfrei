						...
						<div class="card col-md-12">
							...
							<div class="card-block">
								<div class="dt-responsive table-responsive"> 
                                    <h3>All categories (<?php echo count($all_categories);?>)</h3>
                                  <?php
                                    
                                    if(!empty($all_categories)){
                                    ?>
                                    <ul class="list-unstyled page_list" id="nav_category_sort">
                                        <?php 
														...
														<div class="cs-flex cs-flex-mobil cs-outer-coupon coupons_padd" >
															<div class="cs-coupon-box-cell-1  cs-flex cs-flex-mobil coupon_click"  >
																<div class="cs-coupon-logo cs-flex cs-flex-mobil">  
																	 <img style="width: 90px;object-fit: cover;" src="<?php echo base_url();?>uploads/categories/cate_icon<?php echo $coupons['font_icon'];?>">
																</div>
															</div>
