						...
						<div class="card col-md-12">
							...
							<div class="card-block">
								<div class="dt-responsive table-responsive"> 
                                    <h3>All <?php echo $cate_name; ?> subcategories (<?php echo count($all_categories);?>)</h3>
                                  <?php
                                    
                                    if(!empty($all_categories)){
                                    ?>
                                    <ul class="list-unstyled page_list" id="sub_category_sort">
                                        <?php 
                                
                                        foreach($all_categories as $coupons):
                                            
                                            
                                        ?>
                             
                                        <li id="<?php echo $coupons["sub_categories_id"]; ?>">
														...
														<div class="cs-flex cs-flex-mobil cs-outer-coupon coupons_padd" >
															<div class="cs-coupon-box-cell-1  cs-flex cs-flex-mobil coupon_click"  >
																<div class="cs-coupon-logo cs-flex cs-flex-mobil">  
																	 <img style="width: 150px;object-fit: cover;" src="<?php echo base_url();?>uploads/sub_categories/<?php echo $coupons['sub_cat_image'];?>">
																</div>
															</div>
                                    ...
                                    <?php
                                        ...
                                        ?>
                                        <h2 style="font-size: 20px;justify-content: center;display: flex;padding: 35px;background: #8345451c;margin: 27px;">No Category available</h2>
                                       <?php
                                    }
                                    ?>
