					...
					<div class="row">
						<div class="card col-md-12">
							...
							<div class="card-block">
								<form method="POST" action="<?php echo base_url().strtolower($this->session->userdata('directory')); ?>/manage_about_us/update"  enctype="multipart/form-data">
									<div class="row">
										<div class="col-md-12 col-lg-12 col-sm-12">
										    ...
										    <div class="row">
											 ...
											 <div class="row">
												...
												<div class="col-sm-8 col-lg-9">
													<div class="input-group">	
														<textarea  name="editor1" ><?php echo $page_data['description']; ?></textarea>
													</div>
												</div>
											</div>
