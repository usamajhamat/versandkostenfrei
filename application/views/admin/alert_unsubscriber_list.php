									...
									<table id="simpletable" class="table table-striped table-bordered nowrap">
										...
										<tbody>
											...
											<tr>
												...
												<td><a class="" href="javascript:;" onclick="showAjaxModal('<?php echo base_url(); ?>modal/popup/view_reason_alert/<?php echo $fetch_data['voucherr_alert_subscriber_id']; ?>')"> <i class="fa fa-eye"></i>  </a></td>
