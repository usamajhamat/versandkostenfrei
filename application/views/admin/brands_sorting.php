							...
							<div class="card-block">
                                ...
                                ?>
                                  ...
                                  <?php
                                    ...
                                    ?>
                                    <ul class="list-unstyled page_list" id="coupons_code">
                                        <?php 
                                ...
                                ?>
                                    ...
                                    ?>
                                    <ul class="list-unstyled page_list" id="coupons_offer">
                                            <?php 
                                   ...
                                   <?php
                                    if(!empty($coupons_free)){
                                        ?>
                                    <ul class="list-unstyled page_list" id="coupons_free">
                                            <?php 
                                    ...
                                    if(!empty($coupons_shipping)){
                                        ?>
                                                <ul class="list-unstyled page_list" id="coupons_shipping">
                                                        <?php 
                                    ...
                                    if(!empty($coupons_deals)){
                                        ?>
                                                <ul class="list-unstyled page_list"  id="coupons_deals">
                                                        <?php 
