					...
					<div class="row">
						<div class="card col-md-12">
							...
							<div class="card-block">
								<form action="<?php echo base_url().strtolower($this->session->userdata('directory')). '/manage_edit_faqs/edit/'.$param1; ?>" method="post"  enctype ='multipart/form-data'>
                                    ...
                                    <div class="form-group row">
										...
										<div class="col-sm-9">
                                        <textarea name="editor1" data-height='300' data-name='body' ><?php echo $details['answer']; ?></textarea>
										</div>
									</div>
									<div class="form-group row">
