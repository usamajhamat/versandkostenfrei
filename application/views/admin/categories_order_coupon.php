							...
							<div class="card-block">
                                ...
                                ?>
                                  ...
                                  <?php
                                    ...
                                    ?>
                                    <ul class="list-unstyled page_list" id="coupons_code_cate">
                                        <?php 
                                ...
                                ?>
                                    ...
                                    ?>
                                    <ul class="list-unstyled page_list" id="coupons_offer_cate">
                                            <?php 
                                   ...
                                   <?php
                                    if(!empty($coupons_free)){
                                        ?>
                                    <ul class="list-unstyled page_list" id="coupons_free_cate">
                                            <?php 
                                    ...
                                    if(!empty($coupons_shipping)){
                                        ?>
                                                <ul class="list-unstyled page_list" id="coupons_shipping_cate">
                                                        <?php 
                                    ...
                                    if(!empty($coupons_deals)){
                                        ?>
                                                <ul class="list-unstyled page_list"  id="coupons_deals_cate">
                                                        <?php 
