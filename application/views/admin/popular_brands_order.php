						...
						<div class="card col-md-12">
							...
							<div class="card-block">
								<div class="dt-responsive table-responsive"> 
                                    <h3>All popular Brands (<?php echo count($all_brands);?>)</h3>
                                  <?php
                                    
                                    if(!empty($all_brands)){
                                    ?>
                                    <ul class="list-unstyled page_list" id="popular_sort">
                                        <?php 
                                    ...
                                    <?php
                                        ...
                                        ?>
                                        <h2 style="font-size: 20px;justify-content: center;display: flex;padding: 35px;background: #8345451c;margin: 27px;">No Popular Brand available</h2>
                                       <?php
                                    }
                                    ?>
