...
#cs-main { margin-top: 100px !important; }
</style>
...
<input type="submit" value="subscribe" id="subscribe" style="font-size: 13px!important;" class="subscribe_btn"></div>
</div>
</div>
...
Ja, ich möchte einen auf meine Interessen zugeschnittenen individuellen Newsletter erhalten, damit ich keine persönlichen Coupons und Aktionen mehr verpasse. Ich stimme der Analyse meiner Klicks und Öffnungsverhalten zu. Detaillierte Informationen finden Sie in unserer Datenschutzerklärung. Diese Einwilligung kann ich gemäß der Erklärung jederzeit widerrufen.
</label>
</div>
</div>
<?php } ?>
...
?>
    <?php
                                        ...
                                        ?>
<!-- Small Coupon -->
<div class="coupon_box_div coupon_click" data-page="brands" data-coupon = "<?php echo $fetch_data['coupon_type'];?>" data-tag="<?php echo $fetch_data['short_tagline'];?>" data-type="<?php echo $fetch_data['categories_id'];?>" id="<?php echo $brand_name_new.'_'.$fetch_data['coupons_id'];?>" style="position: relative; margin-top: 20px;">
...
<?php if($total_coupons <= $page_limit_initial){ ?>
     <li class="" >
<a class="cs-pagination-item" rel="next" href="<?php echo base_url(); ?>home/coupons/<?php echo $param1;?>?page=<?php echo $page_num; ?>"><?php echo $page_num; ?></a>
</li>
<?php } else { ?>
...
?>
<li ><a class="cs-pagination-item" rel="next" href="<?php echo base_url(); ?>home/coupons/<?php echo $param1;?>?page=<?php echo $page_num - 1; ?>">Previous</a></li>
<?php } ?>
...
<a class="cs-pagination-item" href="<?php echo base_url(); ?>home/coupons/<?php echo $param1;?>?page=<?php echo $i; ?>" class=" <?php if($i == $page_num){ ?> active <?php } ?>"><?php echo $i; ?></a></li>
<?php } ?>
<?php } ?>
<?php } else { ?>
<?php if($i <= $pages_limit){ ?>
...
<li class=" <?php if($i == $page_num) { echo 'cs-pagination-item-active'; }?>" >
<a class="cs-pagination-item" href="<?php echo base_url();?>home/coupons/<?php echo $param1;?>?page=<?php echo $i; ?>" class="active"><?php echo $i; ?></a></li>
<?php } else { ?>
<li class=" <?php if($i == $page_num) { echo 'cs-pagination-item-active'; }?>" >
<a class="cs-pagination-item" href="<?php echo base_url(); ?>home/coupons/<?php echo $param1;?>?page=<?php echo $i; ?>" class=" <?php if($i == $page_num){ ?> active <?php } ?>"><?php echo $i; ?></a></li>
<?php } ?>
...
<li class="<?php if($i == $page_num) { echo 'cs-pagination-item-active'; }?>" >
<a class="cs-pagination-item" href="<?php echo base_url(); ?>home/coupons/<?php echo $param1;?>?page=<?php echo $page_num = $page_num + 1; ?>">Next</a></li>
<?php } else if($pages != $page_num){ ?>
<li class=" <?php if($i == $page_num) { echo 'cs-pagination-item-active'; }?>" >
<a class="cs-pagination-item cs-pagination-next" href="<?php echo base_url(); ?>home/coupons/<?php echo $param1;?>?page=<?php echo $page_num = $page_num + 1; ?>">Next</a>
</li>
<?php } ?>
<?php } ?>
</ul>
