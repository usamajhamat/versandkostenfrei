			...
			<div class="">
				...
				<?php if($page_type == 'by_all'){ ?>
					...
					<section class="section-wrapper">
						<div class="container section-space-top section-space-bottom ">
							<h1 class="cs-home-h"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Gültige Gutscheine fr alle Shops von A-Z</font></font></h1>
							<div class="row">
				...
				<?php } else if($page_type == 'by_id'){
					...
					<section>
							...
							<div class="container">
								<div class="row">
									<div class="col-12 col-md-4 col-lg-3 bg-white justify-content-center">
										<div class="bg-white w-100 h-100 p-4">
											<img class="brand_logo_img w-100 lazyloaded" src="<?php echo base_url().$brand_img_url.$brand_image; ?>" data-src="<?php echo base_url().$brand_img_url.$brand_image; ?>" alt="<?php echo $brand_name ?>" title="<?php echo $brand_name ?>">
									...
									<div class="col-12 col-md-8 col-lg-9 bg-white">
										<div class="bg-white w-100 h-100 p-4">
											<h1 class="box_heading alert_box_head ml-0 pl-0" style="font-size: 28px;"><?php echo $brand_name ?> 
												<?php echo $title ?> in <?php echo strftime("%B")." ".strftime("%Y")?>
											</h1>

											<?php echo substr($brand_desc,0,250); ?>
											<span style="display:none" id="see_<?php echo $brand_id;?>"><?php echo substr($brand_desc,250) ?></span>
								    ...
								    <div class="cs-filter-count" style="color:#5c8374;margin-top: 24px;">
									 	...
									 	<div class="coupons_details" id="coupons_details">  
											<ul class="nav nav-tabs tabs_filter alignment-grid"> 
												...
												<li class="<?php if($active_tab=="Coupon"){ echo "active"; } ;?> li_items li-1st"><a data-toggle="tab" class="filter second-width" href="#coupons"><span>aaaGutscheincode <b class="bold_counter">(<?php echo $count_coupons;?>)</b></span></a></li>
													...
													if(($key+$similar_count+1)==$alert_position){ 
														 ...
														 <div class="cs-couponalert-box row cs-flex">              
																...
																<div class="cs-couponalert-inputs" style="width:100%;">
																  <h3 class="cs-couponalert-form-h3">
																		<font style="vertical-align: inherit;">
																   	<font style="vertical-align: inherit;">Neue <?php echo $brand_name2;?> Gutscheine kostenlos per E-Mail erhalten:</font></font>
																	</h3>
																  ...
																  <div id="js-couponalert-input" class="cs-couponalert-controls controls controls-row">
																	...
																	<label style="margin-top: 5px;">
																	  ...
																	  <font style="vertical-align: inherit;">
																		...
																		<font style="vertical-align: inherit;">
																			<font style="vertical-align: inherit;"> der Datenschutzerklärung und Erklrung zu.</font>
																		</font>
							...
							<table class="coupons_details">
								<thead>
									<tr class="">
										...
										<th ><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Gltig bis</font></font></th>
									</tr>
								</thead>
								<tbody>
									<?php
