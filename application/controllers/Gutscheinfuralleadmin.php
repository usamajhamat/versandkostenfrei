...
class Gutscheinfuralleadmin extends CI_Controller {
	/***** ADMIN INDEX *********/
	...
	public function index(){
		...
		$this->load->view('gutscheinfuralleadmin/login');
	}
	/***** ADMIN INDEX *********/
	/* VERIFY ACCOUNT */
	public function login(){
		...
		if($result != false || !empty($result)){
				...
				$this->session->set_userdata('directory','gutscheinfuralleadmin');
			...
			redirect(base_url().'gutscheinfuralleadmin/dashboard', 'refresh');
		}
	...
	public function forgot_password(){
		$this->load->view('gutscheinfuralleadmin/forgot_password');
	}
	...
	public function resetpassword($verification_code=''){
		...
		$this->load->view('gutscheinfuralleadmin/reset_password',$data);
	}
    ...
    function pages_content($param1='',$param2='',$param3=''){
        ...
        if($param1=='add'){
		   $pagess_id =	$this->input->post('pages_id');
            ...
            $saveData['description']   = $this->input->post('cont_description');
            $saveData['status']        = $this->input->post('status');
            $saveData['date_added']    = date("Y-m-d H:i:s");
    ...
    function similar_brands($param1='',$param2=''){
		...
		$data['brand_data']         = $this->db->get_where('brands',array('status'=>'Active'))->result_array();
        $data['brands_details']     = $this->db->get_where('brands',array('brands_id'=>$param1,'status'=>'Active'))->row();
	...
	public function voucherr_alert_email($param1="",$param2=""){ 
			...
			foreach($all_subscriber as $key => $all_subscr){
			  ...
			  /* $email = 'moavizq@gmail.com'; */
			   ...
			   $message = file_get_contents(base_url()."gutscheinfuralleadmin/voucherr_alert_mail/".$param2."/".$subs_id); 
    ...
    function manage_coupons($param1='',$param2='',$param3=''){
		...
		$data['coupons'] = $this->db->query("select * from coupons where $active_con $in_active_con $expire_con $role_con  order by coupons_id desc")->result_array();
		...
		if($param1 =='update'){
			...
			if($result){
				$this->session->set_flashdata('msg_success', ' Seo settings updated successfuly');
				 redirect(base_url().'gutscheinfuralleadmin/home_page_seo', 'refresh');
			}else{
				$this->session->set_flashdata('msg_error', ' Oops!something went wrong');
				redirect(base_url().'gutscheinfuralleadmin/home_page_seo', 'refresh');
			}
	...
	public function brand_a_z_seo($param1='', $param2=''){
		...
		if($param1 =='update'){
			...
			if($result){
				$this->session->set_flashdata('msg_success', ' Seo settings updated successfuly');
				 redirect(base_url().'gutscheinfuralleadmin/brand_a_z_seo', 'refresh');
			}else{
				$this->session->set_flashdata('msg_error', ' Oops!something went wrong');
				redirect(base_url().'gutscheinfuralleadmin/brand_a_z_seo', 'refresh');
			}
	...
	public function main_category_seo($param1='', $param2=''){
		...
		if($param1 =='update'){
			...
			if($result){
				$this->session->set_flashdata('msg_success', ' Seo settings updated successfuly');
				 redirect(base_url().'gutscheinfuralleadmin/main_category_seo', 'refresh');
			}else{
				$this->session->set_flashdata('msg_error', ' Oops!something went wrong');
				redirect(base_url().'gutscheinfuralleadmin/main_category_seo', 'refresh');
			}
	...
	public function info_blog_seo($param1='', $param2=''){
		...
		if($param1 =='update'){
			...
			if($result){
				$this->session->set_flashdata('msg_success', ' Seo settings updated successfuly');
				 redirect(base_url().'gutscheinfuralleadmin/info_blog_seo', 'refresh');
			}else{
				$this->session->set_flashdata('msg_error', ' Oops!something went wrong');
				redirect(base_url().'gutscheinfuralleadmin/info_blog_seo', 'refresh');
			}
	...
	public function about_us_seo($param1='', $param2=''){
		...
		if($param1 =='update'){
			...
			if($result){
				$this->session->set_flashdata('msg_success', ' Seo settings updated successfuly');
				 redirect(base_url().'gutscheinfuralleadmin/about_us_seo', 'refresh');
			}else{
				$this->session->set_flashdata('msg_error', ' Oops!something went wrong');
				redirect(base_url().'gutscheinfuralleadmin/about_us_seo', 'refresh');
			}
	...
	public function fags_seo($param1='', $param2=''){
		...
		if($param1 =='update'){
			...
			if($result){
				$this->session->set_flashdata('msg_success', ' Seo settings updated successfuly');
				 redirect(base_url().'gutscheinfuralleadmin/fags_seo', 'refresh');
			}else{
				$this->session->set_flashdata('msg_error', ' Oops!something went wrong');
				redirect(base_url().'gutscheinfuralleadmin/fags_seo', 'refresh');
			}
	...
	public function advertise_seo($param1='', $param2=''){
		...
		if($param1 =='update'){
			...
			if($result){
				$this->session->set_flashdata('msg_success', ' Seo settings updated successfuly');
				 redirect(base_url().'gutscheinfuralleadmin/advertise_seo', 'refresh');
			}else{
				$this->session->set_flashdata('msg_error', ' Oops!something went wrong');
				redirect(base_url().'gutscheinfuralleadmin/advertise_seo', 'refresh');
			}
	...
	public function contact_us_seo($param1='', $param2=''){
		...
		if($param1 =='update'){
			...
			if($result){
				$this->session->set_flashdata('msg_success', ' Seo settings updated successfuly');
				 redirect(base_url().'gutscheinfuralleadmin/contact_us_seo', 'refresh');
			}else{
				$this->session->set_flashdata('msg_error', ' Oops!something went wrong');
				redirect(base_url().'gutscheinfuralleadmin/contact_us_seo', 'refresh');
			}
	...
	public function privacy_policy_seo($param1='', $param2=''){
		...
		if($param1 =='update'){
			...
			if($result){
				$this->session->set_flashdata('msg_success', ' Seo settings updated successfuly');
				 redirect(base_url().'gutscheinfuralleadmin/privacy_policy_seo', 'refresh');
			}else{
				$this->session->set_flashdata('msg_error', ' Oops!something went wrong');
				redirect(base_url().'gutscheinfuralleadmin/privacy_policy_seo', 'refresh');
			}
	...
	public function imprints_seo($param1='', $param2=''){
		...
		if($param1 =='update'){
			...
			if($result){
				$this->session->set_flashdata('msg_success', ' Seo settings updated successfuly');
				 redirect(base_url().'gutscheinfuralleadmin/imprints_seo', 'refresh');
			}else{
				$this->session->set_flashdata('msg_error', ' Oops!something went wrong');
				redirect(base_url().'gutscheinfuralleadmin/imprints_seo', 'refresh');
			}
	...
	function send_newsletter($param1='',$param2=''){	
	   ...
	   if($param1=="sub_expiry"){
		 ...
		 /*  print_r($coupun_array); exit;   */
		  ...
		  $cate_array = array_unique($cate_array);
		   ...
		   foreach($all_subscriber as $key => $all_subscr){
			...
			redirect(base_url()."gutscheinfuralleadmin/send_newsletter", 'refresh'); 
		...
		$data['pag_type']       = "";
		$this->load->view('gutscheinfuralleadmin/index', $data);
    }
	public function newletter_email(){ 
			...
			redirect(base_url()."gutscheinfuralleadmin/manage_newsletter_subscription", 'refresh');  		
	}
    /***** Manage Newsletter Subscription *********/
	...
	public function manage_add_faqs($param1='',$param2=''){
		if($param1=='add'){
            ...
            $saveData['answer']        = $this->input->post('answer');
